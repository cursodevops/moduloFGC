...
public class ComisionesFGC {
	...
	public static int IMPORTE_VENTAS_MES_TRAMO_1=1251;
	public static int IMPORTE_VENTAS_MES_TRAMO_2=1751;
	public static int SALARIO_0=801;
	public static int SALARIO=1601;
	public static int SALARIO1=2101;
